            ...
            <div className="bg-gradient-to-t from-transparent via-transparent to-transparent rounded-2xl border border-gray-700 hover:border-yellow-600 transition-colors duration-300 flex flex-col items-center justify-start">
                ...
                <div className='p-6 pb-0 bg-[rgb(22,24,36)] rounded-2xl border border-gray-700'>
                  <div className='flex flex-row justify-center items-center'>
                      <h2 className="text-3xl text-yellow-500 text-center first-line:font-bold mb-2">Ecos do Sur App</h2>
                      <img src="/icons/goto.png" alt="Ver proyecto" className="w-6 h-6 inline-block mb-1 ml-4" />
                  </div>
                  
                  <h2 className="text-l text-gray-400 text-center font-bold mb-4">Trabajo de Fin de Grado — App Móvil Multiplataforma</h2>
                  <p className="text-gray-300 text-left mb-10">Aplicación móvil multiplataforma con chatbot integrado, desarrollada en colaboración con la ONG Ecos do Sur. Destinada a personas potencialmente víctimas de discriminación y agresiones.</p>
                </div>
            </div>
          </a>
          ...
          <a href="projects" className="block group">
            <div className="bg-gradient-to-t from-transparent via-transparent to-transparent rounded-2xl border border-gray-700 hover:border-yellow-600 transition-colors duration-300 flex flex-col items-center justify-start h-full">
                ...
                <div className='p-6 pb-0 bg-[rgb(22,24,36)] rounded-2xl border border-gray-700'>
                  ...
                  <h2 className="text-l text-gray-400 text-center font-bold mb-4">Proyecto en equipo de 4 — HackUDC 2026</h2>
                  <p className="text-gray-300 text-left mb-10">Sistema de gestión de conocimiento personal — un "segundo cerebro" — diseñado para capturar, organizar y transformar información dispersa en conocimiento estructurado.</p>
                </div>
            </div>
          </a>
          ...
          <a href="projects" className="block group">
            <div className="bg-gradient-to-t from-transparent via-transparent to-transparent rounded-2xl border border-gray-700 hover:border-yellow-600 transition-colors duration-300 flex flex-col items-center justify-start h-full">
                ...
                <div className='p-6 pb-0 bg-[rgb(22,24,36)] rounded-2xl border border-gray-700'>
                  ...
                  <h2 className="text-l text-gray-400 text-center font-bold mb-4">Proyecto en grupo de 6 en Universidad - Spring Boot</h2>
                  <p className="text-gray-300 text-left mb-10">Juego hecho en una aplicación web que lleva las ligas fantasy al mundo de los eSports. Cada usuario puede crear su propia liga e invitar a sus amigos.</p>
                </div>
            </div>
          </a>
          ...
          <a href="projects" className="block group">
            <div className="bg-gradient-to-t from-transparent via-transparent to-transparent rounded-2xl border border-gray-700 hover:border-yellow-600 transition-colors duration-300 flex flex-col items-center justify-start h-full">
                ...
                <div className='p-6 pb-0 bg-[rgb(22,24,36)] rounded-2xl border border-gray-700'>
                  ...
                  <p className="text-gray-300 text-left mb-10">Aplicación web que simula un sitio real de compra de productos relacionados con el voley playa. Cuenta con carrito de compras y sistema de cuentas.</p>
                </div>
            </div>
          </a>
          ...
          <a href="projects" className="block group">
            <div className="bg-gradient-to-t from-transparent via-transparent to-transparent rounded-2xl border border-gray-700 hover:border-yellow-600 transition-colors duration-300 flex flex-col items-center justify-start h-full">
                ...
                <div className='p-6 pb-0 bg-[rgb(22,24,36)] rounded-2xl border border-gray-700'>
                  ...
                  <h2 className="text-l text-gray-400 text-center font-bold mb-4">Proyecto en grupo - Fullstack</h2>
                  <p className="text-gray-300 text-left mb-10">Aplicación que eleva tu entrenamiento físico y seguimiento de rutinas al siguiente nivel.</p>
                </div>
            </div>
          </a>
